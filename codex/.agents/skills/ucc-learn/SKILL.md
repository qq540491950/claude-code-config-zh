---
name: ucc-learn
description: 从当前会话中提取可复用的调试与实现模式，并产出可保存的 learned skill 草稿。
---

# ucc-learn

This skill is migrated from legacy command `ucc-learn` and is now executed via Codex Skills.

## Trigger

- Explicit call: `$ucc-learn`
...
在 `~/.codex/skills/learned/[pattern-name].md` 创建技能文件：
